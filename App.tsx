...
import { Heart, Volume2, VolumeX, Send, ArrowLeft, Check, Sparkles } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (step) {
            ...
            <div className="w-full max-w-[320px] space-y-2 px-2">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="w-full py-2 bg-transparent text-gray-400 rounded-full font-cute font-bold text-[10px] uppercase tracking-widest hover:text-gray-800 transition-all"
                >
                  Maybe later?
                </button>
              </div>
      ...
      case Step.LETTER:
        // Letter writer needs to scroll if content is tall, but we try to fit it
        return (
          <div className="h-full flex flex-col justify-center w-full">
            <LetterWriter />
          </div>
